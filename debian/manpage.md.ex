% img-gpu-powervr(SECTION) | User Commands
%
% "August 29 2023"
...
img-gpu-powervr - program to do something

# SYNOPSIS

**img-gpu-powervr** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**img-gpu-powervr** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **img-gpu-powervr** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**img-gpu-powervr** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    img-gpu-powervr. See **foo.conf**(5) for further details.
...
**img-gpu-powervr** provides some return codes, that can be used in scripts:
...
bianbu <lijun.li@spacemit.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 bianbu
