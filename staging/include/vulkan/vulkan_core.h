...
typedef enum VkStructureType {
    ...
    //
    // We need to register these extensions properly
...
//
// Provisional extension for supporting more conditional rendering comparison
// operators than are required in the base Vulkan spec.
//
// Also adds 'VK_STRUCTURE_TYPE_CONDITIONAL_RENDERING_COMPARISON_INFO_IMG' enum
//
...
#define VK_IMG_support_validation 1
#define VK_IMG_SUPPORT_VALIDATION_SPEC_VERSION 1
#define VK_IMG_SUPPORT_VALIDATION_EXTENSION_NAME "VK_IMG_support_validation"

typedef void (VKAPI_PTR *PFN_vkCmdRayTracingPipelineNopIMG)(VkCommandBuffer commandBuffer);
typedef void (VKAPI_PTR *PFN_vkCmdRayTracingPipelineLinkStartIMG)(VkCommandBuffer commandBuffer);
typedef void (VKAPI_PTR *PFN_vkCmdRayTracingPipelineLinkReturnIMG)(VkCommandBuffer commandBuffer);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vkCmdRayTracingPipelineNopIMG(VkCommandBuffer commandBuffer);
VKAPI_ATTR void VKAPI_CALL vkCmdRayTracingPipelineLinkStartIMG(VkCommandBuffer commandBuffer);
VKAPI_ATTR void VKAPI_CALL vkCmdRayTracingPipelineLinkReturnIMG(VkCommandBuffer commandBuffer);
#endif
